...
REAL TOOLS (resolve ROOT="${CLAUDE_PLUGIN_ROOT}/anti-autoresearch"):
...
```bash
ROOT="${CLAUDE_PLUGIN_ROOT}/anti-autoresearch"
...
```bash
ROOT="${CLAUDE_PLUGIN_ROOT}/anti-autoresearch"; PAPER_DIR="<from Step 0>"
