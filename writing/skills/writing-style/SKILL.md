...
**Scope.** RULE-01..13 apply to every writing task: email, message draft, post, doc, paper prose. RULE-P1..P6 apply *only* when the target is a page-capped paper (NeurIPS/ICML/ICLR-style 8-10 page caps and similar); skip them for email and short-form prose where they would over-constrain tone.

## Canonical (RULE-01..13)

Distilled from Strunk & White, Orwell, Pinker, and Gopen & Swan; RULE-13 added by Wenhao Chai.
...
> writing-style v0.5.0 active: 13 canonical rules (RULE-01..13) + 6 page-capped additions (RULE-P1..P6, paper-only).
...
RULE-13 and RULE-P1 through RULE-P6 are additions by Wenhao Chai, distilled from NeurIPS / ICML / ICLR paper-review workflows.
