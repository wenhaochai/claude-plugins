# anti-autoresearch (bundled in the `writing` plugin)

Lives under `writing/anti-autoresearch/` (tools, references, schemas, eval); the 12 skills sit in
`writing/skills/`. Each SKILL.md resolves `ROOT="${CLAUDE_PLUGIN_ROOT}/anti-autoresearch"`.
